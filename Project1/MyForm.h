...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"Номер трамвая";
			// 
			// MyForm
			// 
...
private: System::Void listBox1_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {
	...
	switch (n)
	{
	case 0: label5->Text = "Електромережа - Залізничний вокзал"; break;
	case 1: label5->Text = "ш. Барське - Вишенька - ш. Барське"; break;
	case 2: label5->Text = "м/н Вишенька - Електромережа"; break;
	case 3: label5->Text = "ш. Барське - Залізничний вокзал"; break;
	case 4: label5->Text = "Електромережа - ш. Барське"; break;
	case 5: label5->Text = "Залізничний вокзал - м/н Вишенька"; break;
